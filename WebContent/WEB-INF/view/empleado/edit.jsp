  ...
  <h4 class="ui dividing header">Nuevo Empleado</h4>
    		...
    		<div class="three fields">
      		...
      		<div class="field">
   			...
   			<div class="three fields">   
      			<div class="field">
						<form:label path="tipoDocIdentidad.id">Tipo de Documento</form:label>
      		 	...
      		 	<div class="field">
						<form:label path="doc_identidad">DUI</form:label>
						<form:input path="doc_identidad" placeholder="DUI" />
   			...
   			<div class="two fields">   
      			<div class="field">
						...
						<form:input path="isss" placeholder="ISSS" />
						<form:errors path="isss" />
					</div>
      		 	<div class="field">
						<form:label path="nup">NUP</form:label>
						<form:input  path="nup" placeholder="NUP" />
   			...
   			<div class="two fields">   
      			<div class="field">
						<form:label path="email_pers">Email Persona</form:label>
						<form:input path="email_pers" placeholder="Email Persona" />
						<form:errors path="email_pers" />
					</div>
      		 	<div class="field">
						<form:label path="email_inst"> Email Institucion</form:label>
   			...
   			<div class="two fields">   
      			<div class="field">
						<form:label path="direccion.numCalle">No. Calle</form:label>
   			...
   			<div class="three fields">   
				...
				<div class="field">
						<form:label path="direccion.numCasa">No. Casa </form:label>
